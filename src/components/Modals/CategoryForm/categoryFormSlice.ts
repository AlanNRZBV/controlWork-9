...
export const categoryFormSlice = createSlice({
  ...
  reducers: {
    ...
    editCategory: (state, action: PayloadAction<IApiCategory>) => {
      ...
      state.selected =
        options.find((option) => option.value === editCat.type) || null;
...
export const categoryFormState = (state: RootState) =>
  state.categoryForm.category;
export const categoryFormSelected = (state: RootState) =>
  state.categoryForm.selected;
export const isCategoryFormLoading = (state: RootState) =>
  state.categoryForm.isLoading;
export const isCategoryFormVisible = (state: RootState) =>
  state.categoryForm.isVisible;
export const isCategoryFormEditing = (state: RootState) =>
  state.categoryForm.isEditing;
